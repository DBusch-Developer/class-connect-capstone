...
const Home = () => {
  const topics = [
    ...
    },
    {
      ...
      label: "Ask Ollama",
      description:
        "Want to dive deeper and explore specific questions or topics in real-time? Check out our dedicated conversation page and interact with our Ollama language model tools to get personalized guidance and answers on the go.",
      image: (
        <img
          className="rounded-md opacity-15 w-[25vw] h-[45vh] border border-white"
          src={new URL("../assets/images/code4.jpg", import.meta.url).href}
  ...
  return (
    <>
          ...
          <div className="bg-black h-[105vh] numans">
            ...
            <div className=" grid grid-cols-2 gap-20 pt-20 justify-self-center">
